...
<head>
    ...
    <link href="DecoratorAccount.css" type="text/css" rel="stylesheet">
...
<body>
  ...
  Religion:<input type="date" name="" placeholder="" value="23-08-1996" class="infoClass" id="religion">
  Cast:<input type="date" name="" placeholder="" value="23-08-1996" class="infoClass" id="cast">
  ...
  Credential Image 5:<input type="file" enctype="multipart/form-data" id="credImg5">
    ...
    <script src="DecoratorAccount.js"></script>
    <script>
