...
<body>
    ...
    <div id="menuDivisionUp">
        <p1><a href="HallPageTesting.php" class="meneOption">Home</a></p1>
    ...
    <div id="hall">
        <div id="mainHeader">
            <h1 id="hallHeader">Hallss</h1>
        </div>

        <div class="pageItems">
             <div class="info">
                 <div class="image">
                      <img src="hall_0.jpg" width="100%" height="100%">
                 </div>
                 <div class="lekha">
                     <h2>Informations</h2>
                      Name:<p1>Rawa Community Center</p1><br/>
                      Address:<p1>47/5 Mia Fazilchisti,Sylhet</p1><br/>
                      Contact No:<p1>01796660214</p1><br/>
                      Email:<p1>otpid.is@gmail.com</p1>
                      <form class="more">
                          <input type="submit" name="" value="More Details" class="button" id="H1">
                      </form>
                 </div>
             </div>
        </div>
