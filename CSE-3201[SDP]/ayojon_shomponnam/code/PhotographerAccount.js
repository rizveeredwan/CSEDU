...
function bringOtherElements() {
    ...
    $.ajax({
        ...
        url: ("PhotographerAccountServerPage1.php"), //for getting normal data this page
        method: "POST",
        ...
        success: function(data) {
            ...
            document.getElementById("credImg1").value = data[15];
            credImg1 = data[15];
            document.getElementById("credImg2").value = data[16];
            credImg2 = data[16];
            document.getElementById("credImg3").value = data[17];
            credImg3 = data[17];
            document.getElementById("credImg4").value = data[18];
            credImg4 = data[18];
            document.getElementById("credImg5").value = data[19];
            credImg5 = data[19];
            return false;
        }
...
submit.onclick = function(event) {
    ...
    $.ajax({
        ...
        url: "PhotographerAccountServerPage2.php", //this page is for updating normal data 
        method: "POST",
        data: {
            name: name,
            username: username,
...
$(document).ready(function() {
    ...
    $("#add").click(function() {
        ...
        $.ajax({
            url: "PhotographerAccountServerPage4.php",
            method: "POST",
    ...
    $(document).on("click", ".delButton", function() {
        ...
        $('#row' + x + '').remove();
        $.ajax({
            url: "PhotographerAccountServerPage5.php",
            method: "POST",
            data: { date: date, time: time, customerId: customerId },
            dataType: "text",
            success: function(data) {
...
$(document).ready(function() {
    ...
    function fetchData() {
        $.ajax({
            url: "PhotographerAccountServerPage3.php",
            method: "POST",
            success: function(data) {
