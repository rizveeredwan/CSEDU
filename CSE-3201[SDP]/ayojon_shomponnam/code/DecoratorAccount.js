...
function bringOtherElements() {
    ...
    $.ajax({
        ...
        url: ("DecoratorAccountServerPage1.php"), //for getting normal data this page
        method: "POST",
...
submit.onclick = function(event) {
    ...
    $.ajax({
        ...
        url: "DecoratorAccountServerPage2.php", //this page is for updating normal data 
        method: "POST",
        data: {
            name: name,
            username: username,
...
$(document).ready(function() {
    ...
    $("#add").click(function() {
        ...
        $.ajax({
            url: "DecoratorAccountServerPage4.php",
            method: "POST",
    ...
    $(document).on("click", ".delButton", function() {
        ...
        $('#row' + x + '').remove();
        $.ajax({
            url: "DecoratorAccountServerPage5.php",
            method: "POST",
            data: { date: date, time: time, customerId: customerId },
            dataType: "text",
            success: function(data) {
...
$(document).ready(function() {
    ...
    function fetchData() {
        $.ajax({
            url: "DecoratorAccountServerPage3.php",
            method: "POST",
            success: function(data) {
