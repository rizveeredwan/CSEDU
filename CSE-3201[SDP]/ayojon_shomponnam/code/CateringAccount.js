...
function bringOtherElements() {
    ...
    $.ajax({
        ...
        url: ("CateringAccountServerPage1.php"), //for getting normal data this page
        method: "POST",
...
function bringAllTable() {
    $.ajax({
        url: "CateringAccountServerPage3.php",
        method: "GET",
        data: {},
        dataType: "html",
        success: function(data) {
...
submit.onclick = function(event) {
    ...
    $.ajax({
        ...
        url: "CateringAccountServerPage2.php", //this page is for updating normal data 
        method: "POST",
        data: {
            name: name,
            username: username,
...
$(document).ready(function() {
    ...
    $("#add").click(function() {
        ...
        $.ajax({
            url: "CateringAccountServerPage4.php",
            method: "POST",
    ...
    $(document).on("click", ".delButton", function() {
        ...
        $('#row' + x + '').remove();
        $.ajax({
            url: "CateringAccountServerPage5.php",
            method: "POST",
            data: { date: date, time: time, customerId: customerId },
            dataType: "text",
            success: function(data) {
