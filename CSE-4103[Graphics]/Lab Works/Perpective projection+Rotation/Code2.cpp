...
void general_projection(double x, double y, double z, double &x1, double &y1, double &z1, int d){
	double tx1=(x)/(1+z/d);
	double ty1=(y)/(1+z/d);
	double tz1=(z)/(1+(z/d));
...
void controlling(){
	...
	for(int i=0;i<n;i++){
		...
		if(choice == 0) {
			...
			//then projection
			general_projection(x1,y1,z1,x1,y1,z1,d);
			general_projection(x2,y2,z2,x2,y2,z2,d);
			...
			//around z 
			double x1,y1,z1;
			general_rotation(arr[i].z1,arr[i].x1,arr[i].y1,z1,x1,y1);	
			
			double x2,y2,z2;
			general_rotation(arr[i].z2,arr[i].x2,arr[i].y2,z2,x2,y2);
			...
			//around z 
			double x1,y1,z1;
			general_rotation(arr[i].y1,arr[i].z1,arr[i].x1,y1,z1,x1);	
			
			double x2,y2,z2;
			general_rotation(arr[i].y2,arr[i].z2,arr[i].x2,y2,z2,x2);
