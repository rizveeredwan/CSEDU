...
LM = os.path.join(os.path.dirname(__file__),'..','..','lm', 'text.arpa')
model = kenlm.LanguageModel(LM)
print('{0}-gram model'.format(model.order))

sentence = "বিবর্তনবাদের মাধ্যমে টিকে থাকার জন্য সকলপ্রাণীকূলই প্রয়োজনীয় অভিযোজন ক্ষমতা অর্জন করেছে"
# sentence = 'আমি coding খাই'
print(sentence)
...
for i, (prob, length, oov) in enumerate(model.full_scores(sentence)):
    ...
    if oov:
        print('\t"{0}" is an OOV prob {0}'.format(words[i+1],prob))
