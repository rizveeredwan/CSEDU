...
<body>
    ...
    <div class="table-design" style="background:#0f0f57; color:white;">
        ...
        <div style="margin-left: 2%; margin-right:2%; display:grid; grid-template-columns:32% 32% 32%">
            ...
            <div class="thumbnail facility" style="margin-left:1%; margin-right:1%;" id="research_group_files">
            ...
            <!--Google Drive -->
            <div class="thumbnail facility" style="margin-left:1%; margin-right:1%;" id="google_drive">
            ...
            <!--Dropbox -->
            <div class="thumbnail facility" style="margin-left:1%; margin-right:1%;" id="dropbox">
        ...
        <div style="margin-left: 2%; margin-right:2%; display:grid; grid-template-columns:32% 32% 32%">
            <!--Github-->
            <div class="thumbnail facility" style="margin-left:1%; margin-right:1%;" id="github">
            ...
            <!--Mail -->
            <div class="thumbnail facility" style="margin-left:1%; margin-right:1%;" id="mail">
            ...
            <!--facebook -->
            <div class="thumbnail facility" style="margin-left:1%; margin-right:1%;" id="facebook">
