...
{
       0,    32,    32,    40,    48,    55,    62,    68,    76,    84,
     120,   157,   164,   201,   237,   273,   281,   289,   304,   312,
     327,   395
};
#endif
...
{
  "$end", "error", "$undefined", "INTEGER", "REAL", "ID", "TRUE", "FALSE",
  "'+'", "'-'", "'*'", "'/'", "'='", "','", "'('", "')'", "';'", "$accept",
  "factor", "term", "sum", "expr", "vars", "exprs", "assignment",
  "start_state", YY_NULLPTR
};
#endif
...
{
      -4,   -14,     9,   -14,    10,     0,    18,   -14,   -14,   -14,
     -14,   -14,   -14,    13,     0,   -14,    14,    20,   -14,    -5,
     -14,    14,    11,    13,    13,    13,    13,     0,   -14,   -14,
     -14,   -14,    14,    14,   -14
};
...
{
       0,    16,     0,    21,     0,     0,     0,     1,     4,     5,
       7,     2,     3,     0,     0,     8,    11,    15,    18,     0,
      17,    12,     0,     0,     0,     0,     0,     0,    20,     6,
       9,    10,    13,    14,    19
};
...
{
     -14,     7,   -13,   -14,   -12,   -14,   -14,   -14,   -14
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,    15,    16,    17,    18,     2,    19,     3,     4
};
...
{
      21,     1,    22,     8,     9,    10,    11,    12,    27,    13,
       7,    28,    32,    33,    14,    34,     8,     9,    10,    11,
      12,     5,     6,    20,    23,    24,    29,    14,    25,    26,
      30,    31
};

static const yytype_uint8 yycheck[] =
{
      13,     5,    14,     3,     4,     5,     6,     7,    13,     9,
       0,    16,    25,    26,    14,    27,     3,     4,     5,     6,
       7,    12,    13,     5,    10,    11,    15,    14,     8,     9,
      23,    24
};
...
{
       0,     5,    22,    24,    25,    12,    13,     0,     3,     4,
       5,     6,     7,     9,    14,    18,    19,    20,    21,    23,
       5,    19,    21,    10,    11,     8,     9,    13,    16,    15,
      18,    18,    19,    19,    21
};
...
#line 33 "yacc.y" /* yacc.c:1646  */
    {
		...
		(yyval.sval) = (yyvsp[0].sval); //stack: factor  true
...
#line 41 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s\n",(yyvsp[0].sval));
		(yyval.sval) = (yyvsp[0].sval); //stack : factor false
...
#line 63 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s\n",(yyvsp[-1].sval));
		(yyval.sval) = (yyvsp[-1].sval); //stack : factor generation_from_expr 
	}
...
#line 69 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s\n",(yyvsp[0].sval));
		(yyval.sval) = (yyvsp[0].sval); //stack : factor generation_from_expr 
	}
...
#line 77 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s\n",(yyvsp[0].sval));		
		(yyval.sval) = (yyvsp[0].sval); //stack : factor value_of_factor 
...
#line 85 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("%s = %s * %s\n",address_code,(yyvsp[-2].sval),(yyvsp[0].sval)); //printing t1 = t2 * t3 

		//stack push 
		(yyval.sval) = address_code; // stack: term t1 				
	}
...
#line 158 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s\n",(yyvsp[0].sval));
		(yyval.sval) = (yyvsp[0].sval); //stack: sum t1
	}
...
#line 165 "yacc.y" /* yacc.c:1646  */
    {
		...
		//string cat
		strcat(address_code,num_string); //t1
		printf("%s = -%s\n",address_code,(yyvsp[0].sval)); //printing t1 = -t2 

		//stack push 
		(yyval.sval) = address_code; // stack: sum t1 	
...
#line 274 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s\n",(yyvsp[0].sval));
		(yyval.sval) = (yyvsp[0].sval); //stack: expr t1
	}
...
#line 282 "yacc.y" /* yacc.c:1646  */
    {
		printf("vars from id.\n");
		printf("desired values in stack now: %s\n",(yyvsp[0].sval));
		(yyval.sval) = (yyvsp[0].sval); //stack: vars t1
...
#line 290 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s %s\n",(yyvsp[-2].sval),(yyvsp[0].sval));
		char *temp1,*temp2;
		temp1 = strdup((yyvsp[-2].sval));
		temp2 = strdup((yyvsp[0].sval));
...
#line 305 "yacc.y" /* yacc.c:1646  */
    {
		...
		printf("desired values in stack now: %s\n",(yyvsp[0].sval));
		printf("value = %s\n",(yyvsp[0].sval));
		(yyval.sval)=(yyvsp[0].sval); //stack exprs value_of_expr 	
	}
...
#line 328 "yacc.y" /* yacc.c:1646  */
    {
		...
		char *variable,*ex;
		ex = strdup((yyvsp[-1].sval));
		variable = strdup((yyvsp[-3].sval));
